...
const ServicesAndAboutSection = ({ scrollToSection }: ServicesAndAboutSectionProps) => {
  return (
    <>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto px-2">
              Выберите то, что вам ближе: быстрые и креативные AI-снимки или классическую съемку с живым общением
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                <h3 className="sm:text-2xl font-bold text-base">Классическая съемка</h3>
              </div>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2">
                  <Icon name="Check" className="text-green-500 mt-1 flex-shrink-0" size={18} />
                ...
                <div className="flex items-start gap-2">
                  <Icon name="Check" className="text-green-500 mt-1 flex-shrink-0" size={18} />
                  <p className="text-sm sm:text-base">Живое общение с фотографом</p>
                </div>
                <div className="flex items-start gap-2">
                  <Icon name="Check" className="text-green-500 mt-1 flex-shrink-0" size={18} />
                  <p className="text-sm sm:text-base">Профессиональная студия</p>
                </div>
                <div className="flex items-start gap-2">
                  <Icon name="X" className="text-red-500 mt-1 flex-shrink-0" size={18} />
                  <p className="text-sm sm:text-base">Нужно приехать в Новосибирск</p>
                </div>
                <div className="flex items-start gap-2">
                  <Icon name="X" className="text-red-500 mt-1 flex-shrink-0" size={18} />
      ...
      <section id="services" className="py-12 sm:py-20 px-3 sm:px-6 bg-gradient-to-br from-purple-50 to-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-purple-600 to-black bg-clip-text text-transparent text-2xl">
              Наши цены
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-sm whitespace-nowrap">1 000 ₽</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-sm whitespace-nowrap">3 500 ₽</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Групповая (1 фото, 2 и более человек)</span>
                    <span className="font-bold text-sm whitespace-nowrap">от 500 ₽</span>
                  </div>
                </div>
            ...
            <Card className="border-2 border-purple-200">
              <CardHeader className="bg-gradient-to-r from-purple-50 to-white">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <CardTitle className="text-xl sm:text-2xl md:text-3xl">Классическая съемка</CardTitle>
                </div>
                <CardDescription className="text-sm sm:text-base">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center gap-2">
                      ...
                      <span className="font-bold text-sm whitespace-nowrap">500 ₽</span>
                    </div>
