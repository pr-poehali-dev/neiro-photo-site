...
const Index = () => {
  ...
  const scrollPortfolio = (
    ...
    const containerId =
      photographer === "alexandra" ? "portfolio-alexandra" : "portfolio-maria";
          ...
          >
                ...
                <div className="space-y-2">
                  ...
                  {expandedPhotographer === "alexandra" && (
                    <div className="text-muted-foreground text-xs sm:text-base pt-2 border-t animate-fade-in">
                      ...
                      <p>
                        Вы присылаете мне свои фото хорошего качества,
                        описываете желаемый образ, и я создаю для вас
                        потрясающие снимки в любом стиле: от классического
                        портрета до фэнтезийных образов.
                      </p>
                    </div>
                  )}
                </div>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 animate-scale-in [animation-delay:150ms]">
              <div className="h-32 sm:h-40 md:h-96 bg-gradient-to-br from-secondary/20 to-primary/20 relative overflow-hidden">
                <img
                  src="https://cdn.poehali.dev/files/ddc718a6-a536-4ff9-bd2a-5f1f4192d405.JPG"
                  alt="Мария"
                  className="w-full h-full object-cover opacity-90 transform scale-110"
                />
              </div>
              <CardContent className="p-4 sm:p-6">
                  ...
                  <div
                    ...
                    onClick={(e) => {
                      ...
                      if (img) {
                        ...
                        closeBtn.className =
                          "absolute top-6 right-6 text-[#8B5CF6] bg-white/50 hover:bg-white/50 rounded-full p-2 transition-colors z-10";
                        closeBtn.innerHTML =
          ...
          <div className="text-center space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-4 max-w-2xl mx-auto">
              ...
              >
                ...
                <span>ВКонтакте группа Марии</span>
              </a>
              <a
