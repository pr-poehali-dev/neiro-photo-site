            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-lg ${service.photographer === "alexandra" ? "bg-primary/10" : "bg-secondary/10"} flex items-center justify-center flex-shrink-0`}
                  >
                    <Icon
                      name={service.icon as any}
                      className={
                        service.photographer === "alexandra"
                          ? "text-primary"
                          : "text-secondary"
                      }
                      size={24}
      ...
      <section id="contact" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Свяжитесь с нами для обсуждения съёмки
            </p>
          </div>
