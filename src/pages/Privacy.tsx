        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p>
              ...
              пользователей сайта фотографов Александры и Марии.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Данные о предпочтениях в услугах фотосъёмки</li>
          ...
          <section>
            ...
            <p>
              Мы принимаем соответствующие меры безопасности для защиты ваших персональных данных от 
          ...
          <section>
            ...
            <p>
              ...
              когда это необходимо для предоставления услуг (например, платежные системы) или 
              требуется законом.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Наш сайт может использовать файлы cookie для улучшения пользовательского опыта. 
              Вы можете настроить свой браузер для отказа от cookie.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              свяжитесь с нами через контакты на главной странице сайта.
            </p>
          </section>
