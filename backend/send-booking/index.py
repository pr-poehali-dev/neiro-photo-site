...
📱 Телефон: {phone}"""
        ...
        if package:
            package_names = {
                ...
                'premium': 'Премиум (20 фото, 5 образов) — 3 500 ₽', 'gruppovaya': 'Групповая (1 фото, 2 и более человек) — от 500 ₽' if photographer == 'alexandra' else 'Премиум (2 часа, 30 фото в ретуши) — 7 500 ₽', 'korotkoe video': 'Короткое видео (до 30сек) — 500 ₽', 'mini': 'Мини (30 мин, 7 фото в ретуши) — 2 500 ₽',
                'other': 'Другое'
            }
