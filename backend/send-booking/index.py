...
📱 Телефон: {phone}"""
        ...
        if package:
            package_names = {
                ...
                'Групповая (1 фото, 2 и более человек) — от 500 ₽': 'Групповая (1 фото, 2 и более человек) — от 500 ₽' if photographer == 'alexandra' else 'Премиум (2 часа, 30 фото в ретуши) — 7 500 ₽', 'korotkoe video': 'Короткое видео (до 30сек) — 500 ₽',
