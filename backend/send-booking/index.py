    ...
    try:
        ...
        if package:
            package_names = {
                ...
                'standard': 'Стандарт (10 фото, 2-3 образа) - 2 500 руб' if photographer == 'alexandra' else 'Стандарт (1 час, 15 фото в ретуши) + рилс в подарок - 4 000 руб',
                'premium': 'Премиум (20 фото, 5 образов) - 3 500 руб' if photographer == 'alexandra' else 'Премиум (2 часа, 30 фото в ретуши) + рилс в подарок - 7 500 руб',
                'gruppovaya': 'Портрет поколения (оплата за каждого человека) - от 500 ₽',
